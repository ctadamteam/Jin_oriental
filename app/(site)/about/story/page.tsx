      ...
      <section className="w-full max-w-5xl mx-auto px-4 pt-20 pb-10">
        <div className="flex flex-col items-center">
          ...
          <div className="text-3xl md:text-4xl font-bold flex items-center mb-8">
            <span className="bg-[#08325C] text-white px-2 py-1 mr-1">행복한 진효과</span>를 아시나요?
          </div>
      ...
      <section className="w-full max-w-5xl mx-auto px-4 py-16 md:py-24 border-b border-gray-200">
        <div className="flex flex-col md:flex-row items-stretch">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center py-6 md:py-10 md:pl-10 lg:pl-16">
            ...
            <h3 className="text-3xl md:text-4xl font-normal text-[#08325C] mb-4 tracking-tight text-center">질병이 아닌 <span className="font-bold">사람</span>을 위합니다.</h3>
            <div
              className="w-[92%] h-10 mb-6 self-center"
              style={{
                backgroundColor: '#08325C',
                WebkitMask: "url('/images/story/jin_oriental%20story_line3.png') center / contain no-repeat",
                mask: "url('/images/story/jin_oriental%20story_line3.png') center / contain no-repeat",
              }}
              aria-hidden="true"
            />
      ...
      <section className="w-full max-w-5xl mx-auto px-4 py-16 md:py-24 border-b border-gray-200">
        <div className="flex flex-col md:flex-row-reverse items-stretch">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center py-6 md:py-10 md:pr-10 lg:pr-16">
            ...
            <h3 className="text-3xl md:text-4xl font-normal text-[#08325C] mb-4 tracking-tight break-keep text-center">안전하고 믿을 수 있는 <span className="font-bold">청정약재</span>만 사용합니다.</h3>
            <div
              className="w-[92%] h-10 mb-6 self-center"
              style={{
                backgroundColor: '#08325C',
      ...
      <section className="w-full max-w-5xl mx-auto px-4 py-16 md:py-24 border-b border-gray-200">
        <div className="flex flex-col md:flex-row items-stretch">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center py-6 md:py-10 md:pl-10 lg:pl-16">
            ...
            <h3 className="text-3xl md:text-4xl font-normal text-[#08325C] mb-4 tracking-tight break-keep text-center">언제나 <span className="font-bold">연구하고 고민하는</span> 의료진이 되겠습니다.</h3>
            <div
              className="w-[92%] h-10 mb-6 self-center"
              style={{
                backgroundColor: '#08325C',
      ...
      <section className="w-full max-w-5xl mx-auto px-4 py-16 md:py-24">
        <div className="flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="text-xl md:text-2xl font-medium text-gray-800 leading-snug">
            ...
            <p className="font-bold text-black text-2xl md:text-3xl mt-4">그래서 진한의원의 <span className="text-[#08325C]">'진심 치료'</span> 는 다릅니다.</p>
          </div>
          
          <div className="flex gap-4 md:gap-6">
            <a href="#" className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-[#08325C] hover:bg-[#0E2C51] transition-colors flex flex-col items-center justify-center text-white shadow-lg group">
