        ...
        <div className="w-full max-w-5xl mx-auto px-4">
          ...
          <div className="relative flex flex-col items-center justify-center w-full -mt-[100px]">
            ...
            <div className="hidden md:block relative w-full max-w-5xl h-[700px] lg:h-[800px]">
              ...
              {/* 오른쪽: 위 */}
              <div className="absolute top-[16%] lg:top-[20%] right-0 lg:right-[0%] w-[280px] lg:w-[360px] z-10 flex flex-col gap-3 text-sm md:text-[16px] text-gray-700 leading-relaxed break-keep translate-x-[40px] translate-y-[30px]">
              ...
              {/* 오른쪽: 소장 */}
              <div className="absolute top-[68%] lg:top-[72%] right-0 lg:right-[0%] w-[280px] lg:w-[360px] z-10 flex flex-col gap-3 text-sm md:text-[16px] text-gray-700 leading-relaxed break-keep translate-x-[60px] translate-y-[10px]">
                <div className="flex relative">
