          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
            ...
            <div className="flex flex-col items-center">
              <div className="w-full max-w-[280px] h-[196px] md:h-[228px] rounded-3xl bg-yellow-400 flex items-center justify-center mb-5 shadow-sm overflow-hidden relative">
                 <Image src="/images/personal/detox_section_3_1.png" alt="아이콘 1" fill className="object-cover scale-95" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-full max-w-[280px] h-[196px] md:h-[228px] rounded-3xl bg-yellow-400 flex items-center justify-center mb-5 shadow-sm overflow-hidden relative">
                 <Image src="/images/personal/detox_section_3_2.png" alt="아이콘 2" fill className="object-cover scale-95" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-full max-w-[280px] h-[196px] md:h-[228px] rounded-3xl bg-yellow-400 flex items-center justify-center mb-5 shadow-sm overflow-hidden relative">
                 <Image src="/images/personal/detox_section_3_3.png" alt="아이콘 3" fill className="object-cover scale-95" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-full max-w-[280px] h-[196px] md:h-[228px] rounded-3xl bg-yellow-400 flex items-center justify-center mb-5 shadow-sm overflow-hidden relative">
                 <Image src="/images/personal/detox_section_3_4.png" alt="아이콘 4" fill className="object-cover scale-95" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-full max-w-[280px] h-[196px] md:h-[228px] rounded-3xl bg-yellow-400 flex items-center justify-center mb-5 shadow-sm overflow-hidden relative">
                 <Image src="/images/personal/detox_section_3_5.png" alt="아이콘 5" fill className="object-cover scale-95" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-full max-w-[280px] h-[196px] md:h-[228px] rounded-3xl bg-yellow-400 flex items-center justify-center mb-5 shadow-sm overflow-hidden relative">
                 <Image src="/images/personal/detox_section_3_6.png" alt="아이콘 6" fill className="object-cover scale-95" />
              </div>
