        ...
        <div className="w-full max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
            ...
            <div className="flex flex-col items-center">
              <div className="w-full max-w-[280px] h-[186px] md:h-[218px] rounded-3xl bg-yellow-400 flex items-center justify-center mb-5 shadow-sm overflow-hidden relative">
