          ...
          <div className="relative w-full">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 md:gap-4 relative z-10">
              ...
              <div className="flex flex-col items-center w-full md:w-1/4 relative">
                <p className="text-sm md:text-[18px] text-gray-200 mb-2 break-keep h-[60px] flex items-end justify-center font-normal leading-snug">잘못된 식습관과 피부를 통해<br/>외부독소가 유입</p>
                <div className="relative flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full bg-[#f4f4f4] text-[#3a332d] font-bold text-xl flex items-center justify-center mb-4 relative z-10 shadow-lg">01</div>
                  {/* 수직선 */}
                  <div className="hidden md:block absolute top-12 left-1/2 -translate-x-1/2 w-[2px] h-[22px] bg-white z-0"></div>
              ...
              {/* Step 2 */}
              <div className="flex flex-col items-center w-full md:w-1/4 relative">
                <p className="text-sm md:text-[18px] text-gray-200 mb-2 break-keep h-[60px] flex items-end justify-center font-normal leading-snug">몸속에 지방, 특히 내장지방이 쌓임</p>
                <div className="relative flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full bg-[#f4f4f4] text-[#3a332d] font-bold text-xl flex items-center justify-center mb-4 relative z-10 shadow-lg">02</div>
                  <div className="hidden md:block absolute top-12 left-1/2 -translate-x-1/2 w-[2px] h-[22px] bg-white z-0"></div>
              ...
              {/* Step 3 */}
              <div className="flex flex-col items-center w-full md:w-1/4 relative">
                <p className="text-sm md:text-[18px] text-gray-200 mb-2 break-keep h-[60px] flex items-end justify-center font-normal leading-snug">독소로부터 염증물질이 분비되어<br/>염증이 발생</p>
                <div className="relative flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full bg-[#f4f4f4] text-[#3a332d] font-bold text-xl flex items-center justify-center mb-4 relative z-10 shadow-lg">03</div>
                  <div className="hidden md:block absolute top-12 left-1/2 -translate-x-1/2 w-[2px] h-[22px] bg-white z-0"></div>
              ...
              {/* Step 4 */}
              <div className="flex flex-col items-center w-full md:w-1/4 relative">
                <p className="text-sm md:text-[18px] text-gray-200 mb-2 break-keep h-[60px] flex items-end justify-center font-normal leading-snug">비만, 만성피로, 탈모, 피부질환 등<br/>각종 증상이 발생</p>
                <div className="relative flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full bg-[#f4f4f4] text-[#3a332d] font-bold text-xl flex items-center justify-center mb-4 relative z-10 shadow-lg">04</div>
                  <div className="hidden md:block absolute top-12 left-1/2 -translate-x-1/2 w-[2px] h-[22px] bg-white z-0"></div>
