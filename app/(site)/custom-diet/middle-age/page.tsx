  ...
  return (
    <main className="mid-page">
      <article className="mid-content">
        ...
        <section className="mid-outcome"><p>즉 제반 불편한 증상은 그대로이면서 체중만 감소된 것은 의미가 없습니다.</p><b>[ 소화불량 대사저하, 갱년기 장애 개선 + 체중감량 ]</b><div className="mid-outcome-arrow" aria-hidden="true"><svg width="40" height="32" viewBox="0 0 24 24" fill="#fff99c"><path d="M12 21l-9-9h6V3h6v9h6z"/></svg></div><strong>올바른 다이어트</strong></section>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .mid-hero{display:grid;margin-top:10px;grid-template-columns:672px 328px;height:365px}.mid-hero-photo{position:relative;overflow:hidden}.mid-hero-photo img{object-fit:cover}.mid-hero-copy{padding:58px 0 0 37px;background:#433124}.mid-hero-copy p{margin:0;color:#cfc5bd;font-size:15px;letter-spacing:-1px}.mid-hero-copy h2{display:grid;margin:10px 0 17px;grid-template-columns:1fr 1fr;color:#ffec55;font-size:55px;font-weight:400;line-height:.95}.mid-hero-copy h2 span:nth-child(2){text-align:right;justify-self:end}.mid-hero-copy h2 b{grid-column:1 / -1;margin-top:12px;color:#fff;font-size:55px;font-weight:400;letter-spacing:14px;white-space:nowrap}.mid-hero-copy .mid-hero-detail{font-size:14px;line-height:1.8}
