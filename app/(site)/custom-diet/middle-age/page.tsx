  ...
  return (
    <main className="mid-page">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media(max-width:1000px){.mid-content{width:100%}.mid-hero{grid-template-columns:67.2% 32.8%;height:auto;aspect-ratio:1000 / 365}.mid-hero-copy{padding:5.8vw 0 0 3.7vw}.mid-hero-copy h2,.mid-hero-copy h2 b{font-size:5.5vw}.mid-hero-top-row{width:24.4vw}.mid-herb-grid{gap:1.4vw}.mid-herb{padding-right:3vw;padding-left:3vw}.mid-product-grid{gap:7.6vw 4vw}.mid-products,.mid-injection{padding-right:2vw;padding-left:2vw}}
