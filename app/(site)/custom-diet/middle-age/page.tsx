  ...
  return (
    <main className="mid-page">
      <article className="mid-content">
        ...
        <section className="mid-hero" aria-labelledby="mid-hero-title">
          ...
          <div className="mid-hero-copy">
            ...
            <h2 id="mid-hero-title"><span>중</span><span>년</span><b>다이어트</b></h2>
        ...
        <section className="mid-outcome"><p>즉 제반 불편한 증상은 그대로이면서 체중만 감소된 것은 의미가 없습니다.</p><b>[ 소화불량 대사저하, 갱년기 장애 개선 + 체중감량 ]</b><span aria-hidden="true">↓</span><strong>올바른 다이어트</strong></section>

        <section className="mid-herbs">
          <h2>중년기의 여러문제를 치료하기 위한<br /><strong>특별한 노하우를 담은 한약</strong></h2>
          <div className="mid-herb-grid">{herbs.map((herb, index) => <article className={`mid-herb mid-herb--${index + 1}`} key={herb.name}><Image src={imagePath(herb.image)} alt={herb.name} width={215} height={202} loading="eager" unoptimized /><div><h3>{herb.name}</h3><p>{herb.description}</p><ul>{herb.benefits.map(benefit => <li key={benefit}>{benefit}</li>)}</ul></div></article>)}</div>
        </section>

        <section className="mid-doctor-intro">
          <div><h2>진한의원 중년 다이어트</h2><p>갱년기 증후군을 겪는 여성들은 개인에 따라 정도의 차이가 있지만 몸과 마음에 모두 큰 변화를 겪는 시기인 만큼 적절한 관리가 필요합니다. 때문에 이런 특성을 고려하여 불필요한 지방은 감소시키면서도 근육과 뼈는 최대한 보호하는 갱년기 환자만을 위한 다이어트 프로그램이 반드시 필요합니다.</p><p className="mid-highlight">오랜 기간 비만과 부인과 치료에 대한 임상경험을 축적해온 진한의원 에서는<br />단순한 다이어트 처방만이 아닌 다양한 갱년기 증상을 완화시키고 건강한<br />노후생활을 준비하기 위한 초석을 다지는 갱년기 다이어트 프로세스를 통해<br />자연스러운 체중감량을 도와드립니다.</p></div><Image src={imagePath('MID_11.png')} alt="진한의원 중년 다이어트 안내" width={327} height={472} loading="eager" unoptimized /></section>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .mid-page{width:100%;overflow:hidden;background:#fff;color:#444;font-family:Arial,'Malgun Gothic',sans-serif}.mid-content{width:min(100%,1000px);margin:0 auto;background:#fff}.mid-content *{box-sizing:border-box}.mid-page-heading{height:100px;padding-top:14px;border-bottom:1px dotted #bbb}.mid-page-heading h1{margin:0;color:#0b0b0b;font-family:'Times New Roman','Batang',serif;font-size:38px;font-weight:400;letter-spacing:-4px}
        .mid-hero{display:grid;margin-top:10px;grid-template-columns:672px 328px;height:365px}.mid-hero-photo{position:relative;overflow:hidden}.mid-hero-photo img{object-fit:cover}.mid-hero-copy{padding:58px 0 0 37px;background:#433124}.mid-hero-copy p{margin:0;color:#cfc5bd;font-size:15px;letter-spacing:-1px}.mid-hero-copy h2{display:grid;margin:10px 0 17px;grid-template-columns:1fr 1fr;column-gap:66px;color:#ffec55;font-size:55px;font-weight:400;line-height:.95}.mid-hero-copy h2 b{grid-column:1 / -1;margin-top:12px;color:#fff;font-size:55px;font-weight:400;letter-spacing:14px;white-space:nowrap}.mid-hero-copy .mid-hero-detail{font-size:12px;line-height:1.8}
        .mid-introduction{padding:90px 0 50px}.mid-introduction h2{margin:0 0 26px;color:#9a55ad;font-family:'Times New Roman','Batang',serif;font-size:43px;font-weight:400;letter-spacing:-4px}.mid-introduction p{margin:0;color:#777;font-size:15px;line-height:1.75;letter-spacing:-1.25px}.mid-introduction .mid-lead{margin-bottom:11px;color:#3d3d3d;font-size:18px;font-weight:700;line-height:1.6;letter-spacing:-1.8px}.mid-introduction mark{padding:0;background:linear-gradient(transparent 59%,#fff117 59%,#fff117 91%,transparent 91%)}
        .mid-causes{min-height:565px;padding:52px 58px 48px;background:#70547a;color:#fff}.mid-causes h2{margin:0 0 56px;text-align:center;font-size:38px;font-weight:700;letter-spacing:-3px}.mid-cause-flow{display:flex;align-items:center;justify-content:space-between}.mid-cause-item{display:flex;align-items:center;gap:17px}.mid-cause-item b{display:flex;width:182px;height:182px;align-items:center;justify-content:center;border-radius:50%;box-shadow:0 3px 4px rgba(0,0,0,.3);background:#fff;color:#70547a;text-align:center;font-size:26px;line-height:1.18;letter-spacing:-2.5px}.mid-cause-item b span{display:block}.mid-cause-item i{color:#d9cae2;font-size:62px;font-style:normal;font-weight:200;line-height:1}.mid-causes>p{margin:39px 0 0;padding-top:21px;border-top:6px solid #c9b1d3;color:#fff;font-size:16px;line-height:1.65;letter-spacing:-1.4px;word-break:keep-all}
