  ...
  return (
    <main className="mid-page">
      <article className="mid-content">
        ...
        <section className="mid-hero" aria-labelledby="mid-hero-title">
          ...
          <div className="mid-hero-copy">
            ...
            <h2 id="mid-hero-title">
              <span className="mid-hero-top-row"><span>중년</span><b>비만</b></span>
            </h2>
        ...
        <section className="mid-change">
          ...
          <div className="mid-chart">
            ...
            <svg viewBox="-36 0 936 460" role="img" aria-label="중년 체중감량에 따른 신체 변화 그래프">
              <defs><pattern id="grid" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M 10 0 L 0 0 0 10" fill="none" stroke="#a9a9a9" strokeOpacity=".18" strokeWidth="1" /></pattern></defs>
              <rect x="0" y="0" width="900" height="420" fill="#fff" />
              <rect x="0" y="0" width="900" height="420" fill="url(#grid)" />
              <g stroke="#1b1b1b" strokeWidth="1"><line x1="0" y1="420" x2="900" y2="420" /><line x1="0" y1="0" x2="0" y2="420" /></g>
              <text x="-22" y="103" transform="rotate(-90 -22 103)" fill="#1b1b1b" fontSize="16" fontWeight="700">증상의 정도</text>
              <g stroke="#d5d5d5" strokeDasharray="4 4"><line x1="300" y1="0" x2="300" y2="420" /><line x1="600" y1="0" x2="600" y2="420" /></g>
              <path d="M10 100 C125 105 180 167 280 275 S535 360 890 370" fill="none" stroke="#65ace3" strokeWidth="3" />
              <path d="M10 118 C175 150 210 235 330 290 S590 355 890 385" fill="none" stroke="#61c46c" strokeWidth="3" />
              <path d="M10 150 C152 158 250 169 360 235 S660 360 890 370" fill="none" stroke="#46c9c6" strokeWidth="3" />
              <path d="M10 165 C135 178 198 296 305 350 S640 387 890 396" fill="none" stroke="#e43880" strokeWidth="3" />
              <path d="M10 390 C215 390 280 300 405 208 S705 60 890 60" fill="none" stroke="#765849" strokeWidth="4" />
              <g fill="#1b1b1b" fontSize="16" fontWeight="700"><text x="294" y="452">1개월</text><text x="594" y="452">2개월</text><text x="863" y="452">시간</text></g>
              <g fontSize="16" fontWeight="600" stroke="#fff" strokeWidth="4" strokeLinejoin="round" paintOrder="stroke"><text x="45" y="262" fill="#e43880">복부 팽만감,가스<tspan x="45" dy="21">등의 소화기 불편감</tspan></text><text x="667" y="116" fill="#765849">체력, 신진대사<tspan x="667" dy="21">혈행순환 소화속도</tspan></text><text x="721" y="290" fill="#46c9c6">갱년기증상, 불면,<tspan x="721" dy="20">안면홍조, 상열감 등</tspan></text><text x="786" y="342" fill="#123961">체중</text><text x="696" y="384" fill="#65ace3">부종,순환장애,무기력감 등</text></g>
            </svg>
          </div>
        </section>
        ...
        <section className="mid-outcome">
          ...
          <div className="mid-outcome-arrow" aria-hidden="true">
            <svg width="48" height="40" viewBox="0 0 24 24" fill="#A4B7CC">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                {herbs.slice(0, 4).map((med, idx) => (
                  <div key={idx} className={`${['온궁탕', '공진단', '어혈환'].includes(med.name) ? 'bg-white' : 'bg-[#f9f9f9]'} p-6 rounded-xl border border-gray-200 flex flex-col`}>
                     ...
                     <h3 className="text-2xl font-bold text-[#123961] mb-4 text-center tracking-tight">{med.name}</h3>
                ...
                {herbs.slice(4, 6).map((med, idx) => (
                  <div key={idx} className={`${['온궁탕', '공진단', '어혈환'].includes(med.name) ? 'bg-white' : 'bg-[#f9f9f9]'} p-6 rounded-xl border border-gray-200 flex flex-col sm:flex-row items-center gap-8`}>
                     ...
                     <div className="flex flex-col flex-1 text-left w-full">
                       <h3 className="text-2xl font-bold text-[#123961] mb-3 tracking-tight">{med.name}</h3>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .mid-change{padding:84px 48px 30px;background:#f1f1f1}.mid-change h2{font-size:38px}.mid-chart{background:none}.mid-chart-tabs b{background:#A4B7CC}.mid-chart-tabs b:nth-child(2){background:#123961}.mid-chart-tabs b:nth-child(3){background:#002350}.mid-outcome{min-height:360px;margin-top:42px;background:#123961}.mid-outcome p{font-size:25px}.mid-outcome b{font-size:30px;font-weight:400}.mid-outcome strong{background:#A4B7CC;color:#123961;font-size:39px}
        ...
        .mid-size{padding:108px 24px 0}.mid-size .mid-deco-title{margin-bottom:68px}.mid-size>p{font-size:20px}.mid-size>p strong{color:#123961}.mid-size-copy h3{font-size:25px;letter-spacing:-2px}.mid-size-copy p{font-size:18px;line-height:1.45;letter-spacing:-1.2px}.mid-footer{position:relative;margin-top:72px;margin-bottom:72px;line-height:0}.mid-footer img{display:block}.mid-footer-seo{font-size:15pt}.mid-footer-seo h2,.mid-footer-seo p{position:absolute;margin:0;color:transparent;font:inherit}.mid-footer-seo h2{top:22%;left:27%;font-size:38px;font-weight:700}.mid-footer-seo p{top:47%;left:19%;font-size:26px;line-height:1.5}
        .mid-page-heading{height:77px}.mid-hero-copy h2{margin:8px 0 16px;letter-spacing:0}.mid-hero-copy h2 .mid-hero-top-row{display:inline;width:auto;white-space:nowrap;letter-spacing:0}.mid-hero-copy h2 .mid-hero-top-row>span{color:#A4B7CC;letter-spacing:0}.mid-hero-copy h2 .mid-hero-top-row b{display:inline;margin:0;color:#fff;font-size:inherit;font-weight:400;letter-spacing:0;white-space:normal}.mid-hero-copy>h2>b{display:none}.mid-hero-copy .mid-hero-detail{word-break:keep-all}
        .mid-causes{padding-bottom:70px}.mid-causes>p{position:relative;width:calc(100% + 38px);max-width:none;margin:44px 0 0;padding-top:31px;border-top:0}.mid-causes>p:before{position:absolute;top:0;left:0;width:90px;height:6px;background:#A4B7CC;content:''}
        ...
        .mid-injection>h2{position:relative;padding-bottom:10px;border-bottom:0}.mid-injection>h2:after{position:absolute;bottom:0;left:0;width:291px;height:5px;background:#123961;content:''}.mid-size-copy p{font-size:16px;line-height:1.42}
