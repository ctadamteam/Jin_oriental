  ...
  return (
    <main className="mid-page">
      <article className="mid-content">
        ...
        <section className="mid-change">
          ...
          <div className="mid-chart">
            ...
            <svg viewBox="-36 0 936 460" role="img" aria-label="중년 체중감량에 따른 신체 변화 그래프">
              ...
              <g fontSize="16" fontWeight="600" stroke="#fff" strokeWidth="4" strokeLinejoin="round" paintOrder="stroke"><text x="45" y="262" fill="#e43880">복부 팽만감,가스<tspan x="45" dy="21">등의 소화기 불편감</tspan></text><text x="667" y="116" fill="#765849">체력, 신진대사<tspan x="667" dy="21">혈행순환 소화속도</tspan></text><text x="721" y="290" fill="#46c9c6">갱년기증상, 불면,<tspan x="721" dy="20">안면홍조, 상열감 등</tspan></text><text x="786" y="342" fill="#3c9a28">체중</text><text x="696" y="384" fill="#65ace3">부종,순환장애,무기력감 등</text></g>
            </svg>
          </div>
        </section>
        ...
        <section className="mid-outcome">
          ...
          <div className="mid-outcome-arrow" aria-hidden="true">
            <svg width="48" height="40" viewBox="0 0 24 24" fill="#433124">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .mid-change{padding:84px 48px 30px;background:#f1f1f1}.mid-change h2{font-size:38px}.mid-chart{background:none}.mid-chart-tabs b{background:#c8e36e}.mid-chart-tabs b:nth-child(2){background:#a5c614}.mid-chart-tabs b:nth-child(3){background:#7f9a10}.mid-outcome{min-height:360px;margin-top:42px;background:#a5c614}.mid-outcome p{font-size:25px}.mid-outcome b{font-size:30px;font-weight:400}.mid-outcome strong{background:#433124;color:#a5c614;font-size:39px}
        ...
        .mid-page-heading{height:77px}.mid-hero-copy h2{margin:8px 0 16px;letter-spacing:0}.mid-hero-copy h2 .mid-hero-top-row{display:inline;width:auto;white-space:nowrap;letter-spacing:0}.mid-hero-copy h2 .mid-hero-top-row>span{color:#a5c614;letter-spacing:0}.mid-hero-copy h2 .mid-hero-top-row b{display:inline;margin:0;color:#fff;font-size:inherit;font-weight:400;letter-spacing:0;white-space:normal}.mid-hero-copy>h2>b{display:none}.mid-hero-copy .mid-hero-detail{word-break:keep-all}
        .mid-causes{padding-bottom:70px}.mid-causes>p{position:relative;width:calc(100% + 38px);max-width:none;margin:44px 0 0;padding-top:31px;border-top:0}.mid-causes>p:before{position:absolute;top:0;left:0;width:90px;height:6px;background:#7f9a10;content:''}
        ...
        .mid-injection>h2{position:relative;padding-bottom:10px;border-bottom:0}.mid-injection>h2:after{position:absolute;bottom:0;left:0;width:291px;height:5px;background:#a5c614;content:''}.mid-size-copy p{font-size:16px;line-height:1.42}
