...
function ObesePersonIcon() {
  return (
    <svg width="120" height="120" viewBox="0 0 233 233" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-20 h-20 md:w-28 md:h-28 lg:w-32 lg:h-32 select-none pointer-events-none filter drop-shadow-[0_10px_25px_rgba(139,166,18,0.12)]">
      {/* 바깥 흰색 테두리 레이어 (머리와 몸통 통합) */}
      <g fill="white" stroke="white" strokeWidth="12" strokeLinejoin="round" strokeLinecap="round">
        <ellipse cx="116.5" cy="56" rx="23" ry="29" />
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="bg-[#F4F4F4] rounded-3xl p-6 md:p-10 lg:p-12 mb-10 max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row gap-8 md:gap-6 lg:gap-8 justify-around items-stretch">
            ...
            {/* Obesity stat (좌측) */}
            <div className="flex-1 flex flex-col items-center bg-white rounded-[28px] pt-4 pb-6 px-8 md:pt-5 md:pb-8 md:px-10 shadow-[0_12px_40px_rgba(139,166,18,0.06)] border border-[#8BA612]/5">
              {/* 입체적 피규어 스테이지 (상단) */}
              ...
              <div className="text-center">
                <p className="text-[#6E7560] text-[14px] md:text-[16.5px] lg:text-[18px] mb-1 tracking-tight font-medium">성인 3명 중 1명</p>
            ...
            <div className="flex-1 flex flex-col items-center bg-white rounded-[28px] pt-4 pb-6 px-8 md:pt-5 md:pb-8 md:px-10 shadow-[0_12px_40px_rgba(139,166,18,0.06)] border border-[#8BA612]/5">
              ...
              {/* 설명 텍스트 (하단 중앙) */}
              <div className="text-center">
                <p className="text-[#6E7560] text-[14px] md:text-[16.5px] lg:text-[18px] mb-1 tracking-tight font-medium">성인 5명 중 1명</p>
    ...
    <section className="bg-[#F8F8F8] py-16 md:py-20 lg:py-24 border-t border-gray-200">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-[0_12px_40px_rgba(0,0,0,0.06)] border border-gray-100/80">
          ...
          <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle, #8BA612 1px, transparent 1px)', backgroundSize: '24px 24px' }} />
