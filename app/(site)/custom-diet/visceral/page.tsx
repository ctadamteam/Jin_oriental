    ...
    <section className="relative bg-[#FDF4E9] overflow-hidden min-h-[480px] md:min-h-[640px] lg:min-h-[784px]">
      ...
      <div className="relative max-w-[1920px] mx-auto px-6 md:px-16 lg:px-24 flex flex-col lg:flex-row items-center min-h-[480px] md:min-h-[640px] lg:min-h-[784px]">
        ...
        <div className="flex-1 flex justify-center lg:justify-start pt-10 lg:pt-0">
          <img
            src="/images/personal/visceral-fat/visceral-fat-2.png"
            alt="내장지방형 비만"
            className="w-full max-w-[320px] md:max-w-[450px] lg:max-w-[700px] xl:max-w-[850px] object-contain drop-shadow-lg scale-110 origin-left"
          />
        </div>
        {/* right text */}
        <div className="flex-1 flex flex-col justify-center py-12 lg:py-0 lg:pl-8">
          <p
            className="text-primary text-xl md:text-2xl lg:text-[40px] font-normal mb-3 md:mb-5"
            style={{ letterSpacing: '-0.05em' }}
          >
            뱃살 먼저 감량되는 내장 다이어트
          </p>
          <h1
            className="font-paperlogy text-primary font-extrabold text-5xl md:text-7xl lg:text-[120px] leading-none mb-6 md:mb-8"
            style={{ letterSpacing: '-0.05em' }}
          >
            내장지방형 비만
          </h1>
          <p
            className="text-primary text-base md:text-xl lg:text-[35px] leading-relaxed max-w-[780px]"
            style={{ letterSpacing: '-0.05em' }}
          >
    ...
    <section className="bg-white py-16 md:py-20 lg:py-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex justify-center mb-10">
          <div className="bg-primary text-white px-8 py-3 rounded-full text-lg md:text-2xl lg:text-[35px] font-bold leading-tight">
          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-8 justify-center items-center">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-primary font-extrabold text-3xl md:text-5xl" style={{ letterSpacing: '-0.05em' }}>비만</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-primary font-extrabold text-3xl md:text-5xl" style={{ letterSpacing: '-0.05em' }}>복부비만</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section className="bg-[#F8F8F8] py-16 md:py-20 lg:py-24">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <h2
          ...
          style={{ letterSpacing: '-0.05em' }}
        >
          원인은 <span className="text-primary">내장지방!!</span>
        </h2>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="rounded-2xl bg-[#F0F2E7] overflow-hidden">
          <div className="flex flex-col md:flex-row items-center gap-6 p-8 md:p-10">
            <div className="flex items-center gap-4">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-primary flex flex-col items-center justify-center flex-shrink-0">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
          {causes.map((c) => (
            <div key={c.label} className="flex flex-col items-center gap-3">
              <div className="w-36 h-36 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full bg-sub overflow-hidden flex items-center justify-center">
                <img
                  src={c.img}
                  alt={c.label}
              ...
              <div className="bg-primary text-white rounded-full px-8 py-2 text-lg md:text-2xl font-semibold">
                {c.label}
              </div>
            </div>
          ))}
...
function AbdominalComparisonSection() {
  return (
    <section className="bg-sub py-16 md:py-20 lg:py-24">
      <div className="max-w-6xl mx-auto px-6">
        <h2
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="p-6 md:p-10 flex flex-col lg:flex-row gap-8">
              <div className="flex-1">
                <div className="inline-block bg-primary text-white rounded-full px-6 py-2 text-lg md:text-2xl font-bold mb-6">
                  내장비만인의 복강
                </div>
...
function AgingBellySection() {
  return (
    <section className="relative bg-black overflow-hidden py-16 md:py-20 lg:py-24">
      {/* Blurred bg */}
      <img
        src="/images/personal/visceral-fat/visceral-fat-11.png"
        alt=""
        className="absolute inset-0 w-full h-full object-cover opacity-20 blur-md pointer-events-none select-none"
      />
      {/* Side image */}
      <img
        src="/images/personal/visceral-fat/visceral-fat-12.png"
        alt=""
          ...
          <div className="flex-1 lg:pl-8">
            <div className="flex justify-center lg:justify-start mb-6">
              ...
              >
                ...
                <span className="text-primary font-extrabold">뱃살이 늘어나는 이유</span>
              </h2>
            </div>
            ...
            <p className="text-white text-sm md:text-base lg:text-[35px] leading-relaxed text-center lg:text-left mb-8" style={{ letterSpacing: '-0.05em' }}>
              ...
              <strong className="text-primary">다른 주요 장기와<br className="hidden md:block" />
            ...
            <div className="flex items-center gap-4 mb-6 justify-center lg:justify-start">
              ...
              <div className="text-primary font-extrabold text-4xl md:text-6xl lg:text-[80px]" style={{ letterSpacing: '-0.1em' }}>
                DOWN↓
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 space-y-5">
            {symptoms.map((s) => (
              <div key={s.num} className="flex gap-4">
                <div className="w-8 h-8 md:w-9 md:h-9 bg-primary flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <div key={m.name} className="flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-1.5 h-12 bg-primary flex-shrink-0" />
                ...
                {/* Tags */}
                <div className="border-2 border-dashed border-primary rounded-xl px-4 py-3 flex flex-wrap gap-4">
                  {m.tags.map((tag) => (
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-1 space-y-6">
            {[
              ...
              <div key={item.organ} className="border-l-2 border-primary pl-5">
                <div className="flex items-center gap-3 mb-2 flex-wrap">
                  <span className="text-primary font-bold text-xl md:text-2xl lg:text-[35px]">{item.organ}</span>
                  {item.location && (
                    <span className="text-gray-400 text-sm md:text-base">{item.location}</span>
                  )}
                  {item.tags.map((tag) => (
                    <span key={tag} className="bg-primary text-white text-xs px-2 py-0.5 rounded">{tag}</span>
                  ))}
                </div>
  ...
  return (
    <section className="bg-[#F8F8F8] py-16 md:py-20 lg:py-24">
      <div className="max-w-6xl mx-auto px-6">
        {/* Title badge */}
        <div className="flex justify-center mb-10">
          <div className="bg-primary text-white px-8 py-3 rounded-full text-lg md:text-2xl font-bold">
