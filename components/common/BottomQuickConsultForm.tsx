  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50">
      ...
      <button 
        ...
        className="group w-full bg-gradient-to-r from-[#A8CC1D] to-[#8CA618] text-white py-3 flex flex-row items-center justify-center gap-2 cursor-pointer hover:from-[#B1D422] hover:to-[#98B61C] transition-all duration-300 border-t border-white/20 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] relative z-20"
      >
      ...
      <div 
        className={`backdrop-blur-md bg-[#566249]/95 overflow-hidden transition-[max-height,opacity] duration-500 [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] ${
          isOpen 
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-8 pt-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 lg:gap-5">
              ...
              >
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#A8CC1D] group-focus-within:text-[#8CA618] transition-colors duration-200 pointer-events-none z-10">
                  <User size={16} />
                </span>
                <input 
                  type="text"
              ...
              >
                ...
                <div 
                  className={`absolute top-1 bottom-1 left-1 rounded-lg bg-[#A8CC1D] shadow-sm transition-all duration-300 ease-out pointer-events-none ${
                    formData.gender === 'M' 
              ...
              <button 
                ...
                className={`group w-full md:w-44 bg-[#A8CC1D] hover:bg-[#8CA618] text-white text-sm font-extrabold h-12 rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.25)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.4)] transform active:translate-y-0 cursor-pointer flex items-center justify-center gap-2 border border-white/10 shrink-0 transition-all duration-500 ease-out ${
                ...
                <div className="relative flex items-center justify-center">
                  ...
                  <div 
                    className={`w-5 h-5 rounded-md border transition-all duration-200 flex items-center justify-center ${
                      formData.agree 
                        ? 'bg-white border-white text-[#A8CC1D] shadow-[0_2px_8px_rgba(0,0,0,0.15)]' 
