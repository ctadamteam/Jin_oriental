    ...
    <section className="py-24 bg-white">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          <div className="lg:col-span-5 bg-gray-100 rounded-2xl overflow-hidden h-full min-h-[400px] lg:min-h-[500px] relative">
          ...
          <div className="lg:col-span-7 space-y-8 flex flex-col justify-center">
            ...
            <div className="text-gray-600 space-y-3 leading-relaxed text-[18px] break-keep">
              <p>
                오랜 시간 환자분들의 체중 변화와 몸의 균형을 살피며<br className="hidden md:block" />
                저는 늘 한 가지를 <span className="whitespace-nowrap">중요하게 생각해왔습니다.</span>
              </p>
              <p className="font-semibold text-gray-800">
                “감량은 숫자를 줄이는 일이 아니라,<br />
                몸이 다시 균형을 찾아가는 <span className="whitespace-nowrap">과정이어야 한다.”</span>
              </p>
              <p>
                같은 다이어트를 해도<br />
                누군가는 쉽게 빠지고, 누군가는 <span className="whitespace-nowrap">쉽게 지칩니다.</span><br />
                그 차이는 단순한 의지의 문제가 아니라<br />
                체질, 대사 상태, 스트레스, 수면, 호르몬 변화, 자율신경의 균형과도 <span className="whitespace-nowrap">깊이 연결되어 있습니다.</span>
              </p>
              <p>
                진한의원은<br />
            ...
            <div className="pt-8 border-t border-gray-200/60">
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-y-1.5 gap-x-4 text-[13pt] text-gray-700">
